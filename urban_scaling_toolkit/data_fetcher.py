...
service_tags = {
    ...
    "food": {"amenity": ["restaurant", "fast_food", "fast_food", "food_court", "cafe", "bubble_tea", "ice_cream", "pub", "biergarten", "bar"]}, 
...
def fetch_territory(territory_name):
    ...
    territory = territory["geometry"]
    territory = territory.reset_index(drop=True)
